...
#### Drive view 
* I found error no this tag.  `<meta charset="utf-8">` from the head as it was marking it as error
interesting article [here](https://dev.to/maggiecodes_/why-is-lt-meta-charset-utf-8-gt-important-59hl#:~:text=Furthermore%2C%20most%20browsers%20use%20UTF,There%20you%20have%20it.) about this tag. The interesting thing is that the head is identical for all pages - it comes from base.html template, but only this page returns some kind of error connected with this tag.

* I left warnings about charset attribute on the script being obselete and warning that type attribute is unnecessary for JavaScript resources. They all seemed to have been generated by jquery CDN injecting this script into the head. 
