...
class UserProfile(models.Model):
    ...
    your_address = models.CharField(
        verbose_name="Your Address", max_length=100, null=True, blank=True
    )
    ...
    employee_ref_number = models.CharField(
        verbose_name="Your Employee Refference Number",
        max_length=50,
        null=False,
        blank=True,
    )
    ...
    employer_organization = models.CharField(
        verbose_name="Employer Organization",
    ...
    employer_address = models.CharField(
        verbose_name="Employer's Main Office",
        max_length=100, null=True, blank=True
    )
    employer_longitude = models.CharField(
        verbose_name="Employer's Longitude",
        max_length=50, null=True, blank=True
    )
    employer_latitude = models.CharField(
        verbose_name="Employer's Latitude",
        max_length=50, null=True, blank=True
    )
